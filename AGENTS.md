...
- `tests` — unit tests for config, ddserve config/cache/install/search/server helpers, scanner/parser behavior, SQLite store behavior, Annoy indexing, vector helpers, and clipboard image encoding.
